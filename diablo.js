...
global.ownerName = 'sajomamang'
global.ownerNumber = ["6288269576044@s.whatsapp.net"]
global.prefa = ['','.']
global.mess = {
...
//=================================================//   
const reply = (teks) => {
return diablo.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC AZAAALYNNE`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"6281389368689Url": `https://youtube.com/@azaaalynne`}}}, { quoted: m })} 	
//=================================================// 
try {
...
° Version : 2
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
^BUG BOT VIP BY AZAAALYNNE^
Info Botꫂ]
╭┈─────────────⩵꙰ཱི
⎙ : *Name Own* : SAJO
⎙ : *Name bot* : YAPIT GAMERz🔥
⎙ : *Nama sc* : BUG VIP PRIVATE🔥
╰───➤ 
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
❤️]
╭▱▰▱▰▱▱▰▱▰▱〘 𝙊𝙏𝙃𝙀𝙍 〙▱▰▱▰▱▰▱▰▱
...
break
case 'akses':
diablobotwhatsapp.reply(`UNTUK AKSES BOT CHAT OWNER : wa.me/6288269576044`)
break
case 'sewa':
diablobotwhatsapp.reply(`UNTUK SEWA BOT CHAT OWNER : wa.me/6288269576044`)
break
...
touchmebre = [
{
title: `🌷 AZAAALYNNE 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
diablo.sendListMsg(m.chat, `🌷 AZAAALYNNE 🌷`, diablo.user.name, `Hay Kak Sc Bot Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
